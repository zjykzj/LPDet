...
Usage - Single-GPU training:
    $ python train_rpnet.py ../datasets/CCPD2019/ccpd_base ../datasets/CCPD2019/ccpd_weather runs/train_rpnet

Usage - Multi-GPU DDP training:
    $ python -m torch.distributed.run --nproc_per_node 4 --master_port 32532 train_rpnet.py --device 4,5,6,7 --wr2-pretrained runs/wR2-e45.pth ../datasets/CCPD2019/ccpd_base ../datasets/CCPD2019/ccpd_weather runs/train_rpnet_ddp
